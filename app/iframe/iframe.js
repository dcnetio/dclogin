  ...
  try {
    ...
    if (message.success) {
      const flag = ethersHelper.verifyEIP712Signature(
        waitSignEip712Message.primaryType,
        waitSignEip712Message.domain,
        waitSignEip712Message.type,
        waitSignEip712Message.message,
        message.signature,
        waitSignEip712Message.account
      );
      if (!flag) {
