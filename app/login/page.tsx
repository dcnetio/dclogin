...
export default function Login() {
 ...
 return (
  ...
  <div className={styles.openSourceSection}>
    ...
    <div className={styles.loginContainer}>
      <div className={styles.logoSection}>
        ...
        <p className={styles.subtitle}>{t('login.subtitle', '您正在使用去中心化统一登录')}</p>
       
        {/* Add mobile description here */}
       {isMobile && (
  <div className={styles.mobileDescription}>
    <p className={styles.mobileIntro}>
      {t('wallet.mobile_intro', 'DCWallet 是一款基于去中心化云服务开发的统一登录工具。具备安全、私密和高效的特点，确保您的数据安全。')}
    </p>
  ...
  <div className={styles.registerPrompt} onClick={gotoRegister}>
    {t('login.no_account', '没有账户?')} <span className={styles.registerLink}>{t('login.register_now', '立即注册')}</span>
  </div>
</div>
        </div>
      </div>
